...
class Row {
    ...
    load_data(fields,record) {
        ...
        fields.forEach((fld,colIdx)=>{
            let cell = new Cell(this,colIdx,fld,record[fld] ? record[fld] : null);
...
<th>
    <div class="text-center">
        <button onclick="confirm_modal('Are you sure you want to delete selected records?',()=>$(this).parents('table').data().sheet.delete_selected())">Del Sel</button>
    </div>
</th>
    `;
    #headerCell = `
