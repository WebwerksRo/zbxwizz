...
class Row {
    ...
    #rowMenu = "<a class='dropdown-item' role='button'  href='#' onclick='$(this).parents(\"tr\").data().rowRef.info()'>Row info</a>"+
                ...
                '<a class="dropdown-item" role="button"  href="#" onclick="alert(\'Not implemented\')">Insert empty row</a>'+
    ...
    render() {
        let self = this;
        $("<td align='center' style='background-color: white'>").appendTo(this.#el.empty()).append($("<input type='checkbox'>").on("change",()=>self.select()));
