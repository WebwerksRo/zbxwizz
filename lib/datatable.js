    ...
    <div class="filter dropdown" >
        ...
        <div class="dropdown-menu bg-light">
            <form class="p-2 m-0">
                ...
                <div class="form-group">
                    <select onclick="$(this).parents('table').data().sheet.get_unique(this)" style="width: 100%" onchange="$(this.form.term).val($(this).val()).trigger('change')"></select>
                </div>
...
<!--    <div><button onclick="tranform(this)">Transform</button></div>-->
    ...
    rename_col(colIdx,newName) {
        if(this.#cols.hasOwnProperty(newName)){
