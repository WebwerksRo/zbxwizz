...
class WorkSheets {
    ...
    #sheetSelectorTabTpl = `<li class="nav-item" role="presentation">
                    ...
                    role="tab" aria-controls="sheet1" aria-selected="true" data-idx="1"  ondblclick="edit_tab(this)">Sheet1</a>
                </li>`;
    ...
    activate_sheet(wsId,event="") {
        ...
        //if(!tab.hasClass("active")) return tab.tab("show");
        console.log("activate_sheet "+wsId + " from " + event);
    ...
    new_sheet(wsId, data = null) {
        ...
        $(this.#sheetSelectorTabTpl).appendTo(this.#tabsContainer).removeClass("d-none")
            ...
            .on("shown.bs.tab", (event) => {
                this.activate_sheet($(event.target).attr("aria-controls"),"click");
        ...
        this.sheets[wsId] = new DataTable(container,30, data);
    ...
    rename_sheet(oldName,newName) {
        ...
        this.activate_sheet(newName,"rename");
    }
}
