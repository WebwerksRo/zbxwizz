...
function req_import_from_api(sheet, form, validTpl=false,success=new Function()) {
    console.log(sheet, form, validTpl);
    if(!validTpl) {
...
function update_help_link(src,object,method){
    $(src).parents("form").find(".zbxapihelp").attr("href","https://www.zabbix.com/documentation/current/en/manual/api/reference/"+object+"/"+method)
}
/**
 *
 * @param filter
